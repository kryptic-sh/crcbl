...
| Gamepad: evdev (Linux) + Web Gamepad API — **evdev built** (2026-09-23) onto the seam, with its layouts, normalisation, mapping and hotplug transitions tested against scripted devices; the real `ioctl`/`read` path runs only on the Linux CI jobs, and no controller has been through it. Web Gamepad API not built.                                                                                                                                                                                                                                                                                 | P10                                             |
