...
| Gamepad: XInput / GameController — **XInput built** (2026-09-23) onto the seam above, with its layouts, normalisation and slot transitions tested and a real `XInputGetState` call checked against an empty slot; no controller has been through it. GameController not built.                                                                                                                                                                                                                                                                                                                                                     | P14                                             |
