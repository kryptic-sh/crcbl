...
- The demo site's pages are rendered from one layout (`web/templates/` +
  ...
  edit to every existing page — which is the property S1B is the first to
  actually exercise.
