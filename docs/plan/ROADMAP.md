...
| post    | **Wave 1**: skeletal animation (17) → **puppet** sample; gamepad XInput/GameController (19); on-screen touch controls; TAA + auto-exposure + point shadows (18). Then: L2 contacts → **arena** (prediction/lag-comp forcing function), L3 joints, QUIC native, packaging                                                                                                                                                                            | 5, post           |                                                                                    |
