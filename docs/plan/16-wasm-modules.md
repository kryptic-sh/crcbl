...
| Slice                                                                    | Roadmap phase                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Module API (trait) + static binding — samples use it from the start      | **Built** — `crcbl_ecs::game_module`'s `GameModule`. Implemented by every sample that puts game state on a server. Three of the fixtures that carry none now say so: `apps/viewer`, `apps/lantern` (`docs/plan/sample/13-lantern.md`) and `apps/quarry` (`docs/plan/sample/14-quarry.md`) each claim exemption from sample rules 2 and 10 on the ground that they open no `World` and have no game state to place. `apps/bracket` and `apps/sparks` carry none and claim no exemption. This row said "every sample" until 2026-08-23. |
