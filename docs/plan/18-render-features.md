...
| TAA (jitter, motion vectors); temporal SSR; shadow atlases                                                                                    | post-MVP. Auto-exposure left this row on 2026-08-29 (post stack), and the `GpuInstance` slot it named is **reserved since 2026-08-27** — what TAA and temporal SSR still owe is the motion-vector pass                                                                                                                                              |
