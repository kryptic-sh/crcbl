...
for a pass of its own. Contact shadows stay first; the cone trace and the SDF
path stay where they were as the RT tier's raster alternatives, not scheduled.
...
| **The shadow atlas proper: variable tiles, priority, budget**                                                                                                                                 | [45-shadows.md](45-shadows.md) — **landed 2026-08-31, all five items**: the quadtree allocator, a per-light priority read off one scorer, the per-slot rectangle in `FrameUniforms`, the atlas held across frames, and the cadence and face budget that bound a frame where everything moved. Both new limits default to what shipped, so no golden moved; whether any tier turns the cadence on is `docs/backlog.md`'s open decision and wants (g)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
