...
| **The shadow atlas proper: variable tiles, priority, budget**                                                                                                                                 | [45-shadows.md](45-shadows.md) — pulled forward 2026-08-30 so a many-light scene shadows; the allocator and the per-slot rectangle landed 2026-08-31, and priority, budget and static caching ride on the cadence rung                                                                                                                                                                                                                                                                                                                                                                                                                                    |
