...
| **One `antialiasing` row, then MSAA 2×/4×/8× above SMAA**                         | [49-antialiasing.md](49-antialiasing.md)'s eighth decision — the settings row first, the depth resolve second                                                                                                                                                                                                                                                                                                                    |
