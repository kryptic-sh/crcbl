...
| **The `suzanne` and `gallery` demos** — CC0 PBR models as the material rungs' fixtures ([sample/21-gallery.md](sample/21-gallery.md)); the Stanford bunny is research-only and out | `suzanne` lands with the normal-map rung as its golden; `gallery` when (d) holds more than one texture set                                                                                                                                                                                                                                                                                                                       |
