...
front of it has grown a depth prepass, the background and sky, the contact
shadow march, the froxel volume, debug draw and the ground grid.
`crcbl_render::forward`'s own section comments are the list; this sentence used
to enumerate five passes and claim to be verified, which is how it went three
passes stale without anyone noticing.
