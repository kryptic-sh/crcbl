...
//! [`crate::zone`], and the UI pass — the menu drawn in it — rule 4 asks
//! every sample for.
//!
...
use crcbl::render::{
    Camera, EffectRequest, ForwardRenderer, MAX_TIMED_PASSES, PassTimers, RenderEffects,
...
impl Gpu {
    ...
    /// hold, if the UI compositor refused the device, or if any
    /// HAL call failed.
