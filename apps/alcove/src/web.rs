...
//! ten symbols listed below. That module is also where the reasons live: why
...
//! knobs**, which are the table below. The symbol names stay here too, written
...
//!
//! `__crcbl_alcove_` is this module's prefix. **What each of the ten lifecycle
...
//!
//! [`__crcbl_alcove_prepare`], [`__crcbl_alcove_log_level`],
//! [`__crcbl_alcove_boot`], [`__crcbl_alcove_frame`],
//! [`__crcbl_alcove_status`], [`__crcbl_alcove_shutdown`],
//! [`__crcbl_alcove_error_ptr`], [`__crcbl_alcove_error_len`],
//! [`__crcbl_alcove_log_take`], [`__crcbl_alcove_log_ptr`].
//!
