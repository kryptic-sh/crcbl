...
bootDemo({
  init,
  hint: 'up/down picks a row, left/right moves a fader or RENDER SCALE and steps FRAME CAP, ANISOTROPY or an effect switch · ENTER steps a row round and presses SAVE or RESET · F3 shows the panel and the file · F11 fullscreen',
  savedLabel: 'Settings',
  bind: (ex) => ({
