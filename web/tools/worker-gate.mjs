...
async function main() {
  ...
  // the calling thread whether or not a worker ever wakes — that is a property
  // of the pool, and it is why "the answer was right" cannot stand in for "a
  // worker ran it". One worker is not enough for the shared-TLS assertion
  // below to have anything to see.
