...
fn vertexMain(@builtin(vertex_index) index_0 : u32, @builtin(instance_index) instance_id_0 : u32) -> VertexOutput_0
{
    ...
    var _S1 : bool = (((instances_0[visible_instances_0[draw_0.base_0 + instance_id_0]].flags_0) & (u32(2)))) != u32(0);
    ...
    output_0.world_normal_0 = (((vertex_0.normal_0.xyz) * (normal_basis_0(mat3x3<f32>(_S2[i32(0)].xyz, _S2[i32(1)].xyz, _S2[i32(2)].xyz)))));
    var _S3 : vec4<f32>;
