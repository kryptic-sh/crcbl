...
fn tile_tap_0( tile_1 : u32,  tile_uv_2 : vec2<f32>,  spoke_1 : vec2<f32>,  rotation_1 : vec2<f32>,  reference_1 : f32) -> f32
{
    ...
    return (textureSampleCompareLevel((shadow_atlas_0), (shadow_sampler_0), (atlas_uv_0(tile_1, clamp(tile_uv_2 + vec2<f32>(_S25 * _S26 - _S27 * _S28, _S25 * _S28 + _S27 * _S26) * texel_1 * grid_1, tile_min_0, vec2<f32>(1.0f) - tile_min_0))), (reference_1)));
}

fn tile_pcf_0( tile_2 : u32,  tile_uv_3 : vec2<f32>,  reference_2 : f32,  pixel_2 : vec2<f32>,  radius_1 : f32) -> f32
{
    var _S29 : vec2<f32> = shadow_rotation_0(pixel_2);
    ...
    for(;;)
    {
        ...
        var probe_1 : f32 = probe_0 + tile_tap_0(tile_2, tile_uv_3, SHADOW_DISC_0[SHADOW_PROBE_INDEX_0[spot_0]] * vec2<f32>(radius_1), _S29, reference_2);
        spot_0 = spot_0 + u32(1);
        probe_0 = probe_1;
    }
    if(probe_0 <= 0.0f)
    ...
    for(;;)
    {
        ...
        var visibility_1 : f32 = visibility_0 + tile_tap_0(tile_2, tile_uv_3, SHADOW_DISC_0[index_2] * vec2<f32>(radius_1), _S29, reference_2);
...
fn cascade_visibility_0( cascade_1 : u32,  world_position_3 : vec3<f32>,  to_light_2 : vec3<f32>,  geometric_normal_1 : vec3<f32>,  pixel_3 : vec2<f32>) -> f32
{
    ...
    return tile_pcf_0(cascade_1, tile_uv_4, _S31, pixel_3, sun_penumbra_texels_0(cascade_1, tile_uv_4, _S31, shadow_rotation_0(pixel_3)));
}
...
@fragment
fn fragmentMain( _S71 : pixelInput_0, @builtin(position) position_4 : vec4<f32>) -> FragmentOutput_0
{
    ...
    var _S79 : vec2<f32> = position_4.xy;
    ...
    var lit_1 : vec3<f32> = diffuse_albedo_0 * ((frame_0.ambient_0.xyz + sky_irradiance_0(normal_4) + probe_irradiance_0(_S71.world_position_9, normal_4)) * vec3<f32>(occlusion_at_0(_S79)) + direct_0) + gloss_0 * specular_compensation_0(f0_2, _S78, roughness_3);
    var _S92 : vec3<f32> = emissive_of_0(&(_S74));
