...
fn sun_penumbra_texels_0( cascade_0 : u32,  tile_uv_1 : vec2<f32>,  reference_0 : f32,  rotation_0 : vec2<f32>) -> f32
{
    ...
    const _S16 : vec2<f32> = vec2<f32>(1.0f, 1.0f);
    var _S17 : vec2<f32> = _S16 / texel_0;
    ...
    for(;;)
    {
        ...
        var _S18 : f32 = spoke_0.x;
        var _S19 : f32 = rotation_0.x;
        var _S20 : f32 = spoke_0.y;
        var _S21 : f32 = rotation_0.y;
        var _S22 : vec3<i32> = vec3<i32>(vec2<i32>(min(atlas_uv_0(cascade_0, clamp(tile_uv_1 + vec2<f32>(_S18 * _S19 - _S20 * _S21, _S18 * _S21 + _S20 * _S19) * texel_0 * grid_0, _S15, vec2<f32>(1.0f) - _S15)) * _S17, _S17 - _S16)), i32(0));
        var depth_1 : f32 = (textureLoad((shadow_atlas_0), ((_S22)).xy, ((_S22)).z));
    ...
    var _S23 : f32 = 2.0f * frame_0.cascade_far_0[cascade_0];
...
fn tile_pcf_0( tile_1 : u32,  tile_uv_2 : vec2<f32>,  reference_1 : f32,  pixel_2 : vec2<f32>,  radius_1 : f32) -> f32
{
    ...
    var _S24 : vec2<f32> = vec2<f32>(0.5f, 0.5f) * texel_1 * grid_1;
    var _S25 : vec2<f32> = shadow_rotation_0(pixel_2);
    ...
    for(;;)
    {
        ...
        var _S26 : f32 = spoke_1.x;
        var _S27 : f32 = _S25.x;
        var _S28 : f32 = spoke_1.y;
        var _S29 : f32 = _S25.y;
        var visibility_1 : f32 = visibility_0 + (textureSampleCompareLevel((shadow_atlas_0), (shadow_sampler_0), (atlas_uv_0(tile_1, clamp(tile_uv_2 + vec2<f32>(_S26 * _S27 - _S28 * _S29, _S26 * _S29 + _S28 * _S27) * texel_1 * grid_1, _S24, vec2<f32>(1.0f) - _S24))), (reference_1)));
...
fn cascade_visibility_0( cascade_1 : u32,  world_position_3 : vec3<f32>,  to_light_2 : vec3<f32>,  geometric_normal_1 : vec3<f32>,  pixel_3 : vec2<f32>) -> f32
{
    ...
    var _S31 : f32 = ndc_0.z;
    return tile_pcf_0(cascade_1, tile_uv_3, _S31, pixel_3, sun_penumbra_texels_0(cascade_1, tile_uv_3, _S31, shadow_rotation_0(pixel_3)));
}
...
fn sun_visibility_0( world_position_4 : vec3<f32>,  to_light_3 : vec3<f32>,  n_dot_l_1 : f32,  geometric_normal_2 : vec3<f32>,  pixel_4 : vec2<f32>) -> f32
{
    ...
    return mix(visibility_2, cascade_visibility_0(_S32, world_position_4, to_light_3, geometric_normal_2, pixel_4), blend_0);
}

fn point_face_0( from_light_0 : vec3<f32>) -> u32
{
    var axis_2 : vec3<f32> = abs(from_light_0);
    var _S33 : f32 = axis_2.x;
    var _S34 : f32 = axis_2.y;
    var _S35 : bool;
    if(_S33 >= _S34)
    {
        _S35 = _S33 >= (axis_2.z);
...
fn punctual_visibility_0( tile_3 : u32,  world_position_5 : vec3<f32>,  to_light_4 : vec3<f32>,  n_dot_l_2 : f32,  texel_world_1 : f32,  geometric_normal_3 : vec3<f32>,  pixel_5 : vec2<f32>) -> f32
{
    ...
    var _S37 : f32 = clip_1.w;
    if(_S37 <= 0.0f)
    {
        return 1.0f;
    }
    var ndc_1 : vec3<f32> = clip_1.xyz / vec3<f32>(_S37);
    var _S38 : bool;
...
fn specular_albedo_at_0( n_dot_v_1 : f32,  roughness_1 : f32) -> f32
{
    ...
    var low_0 : vec2<f32> = clamp(floor(scaled_0), vec2<f32>(0.0f, 0.0f), _S40);
    var weight_0 : vec2<f32> = clamp(scaled_0 - low_0, vec2<f32>(0.0f), vec2<f32>(1.0f));
    var _S41 : vec2<i32> = vec2<i32>(low_0);
    var _S42 : vec2<i32> = vec2<i32>(min(low_0 + _S39, _S40));
    var _S43 : i32 = _S41.x;
    var _S44 : i32 = _S41.y;
    var _S45 : vec3<i32> = vec3<i32>(_S43, _S44, i32(0));
    var _S46 : i32 = _S42.x;
    var _S47 : vec3<i32> = vec3<i32>(_S46, _S44, i32(0));
    var _S48 : f32 = weight_0.x;
    var _S49 : i32 = _S42.y;
    var _S50 : vec3<i32> = vec3<i32>(_S43, _S49, i32(0));
    var _S51 : vec3<i32> = vec3<i32>(_S46, _S49, i32(0));
    return mix(mix(decode_specular_albedo_0((textureLoad((specular_albedo_0), ((_S45)).xy, ((_S45)).z).xy)), decode_specular_albedo_0((textureLoad((specular_albedo_0), ((_S47)).xy, ((_S47)).z).xy)), _S48), mix(decode_specular_albedo_0((textureLoad((specular_albedo_0), ((_S50)).xy, ((_S50)).z).xy)), decode_specular_albedo_0((textureLoad((specular_albedo_0), ((_S51)).xy, ((_S51)).z).xy)), _S48), weight_0.y);
}
...
{
    var _S52 : GpuProbe_std430_0 = probes_0[min((cell_1.z * frame_0.probe_counts_0.y + cell_1.y) * frame_0.probe_counts_0.x + cell_1.x, max(frame_0.probe_counts_0.w, u32(1)) - u32(1))];
    var _S53 : GpuProbe_0 = GpuProbe_0( _S52.sh_r_0, _S52.sh_g_0, _S52.sh_b_0 );
    return _S53;
}
...
fn lerp_probe_0( a_0 : GpuProbe_0,  b_0 : GpuProbe_0,  t_0 : f32) -> GpuProbe_0
{
    ...
    var _S54 : vec4<f32> = vec4<f32>(t_0);
    blended_0.sh_r_0 = mix(a_0.sh_r_0, b_0.sh_r_0, _S54);
    blended_0.sh_g_0 = mix(a_0.sh_g_0, b_0.sh_g_0, _S54);
    blended_0.sh_b_0 = mix(a_0.sh_b_0, b_0.sh_b_0, _S54);
    return blended_0;
}

fn probe_irradiance_0( world_position_8 : vec3<f32>,  normal_3 : vec3<f32>) -> vec3<f32>
{
    var _S55 : vec3<f32> = vec3<f32>(1.0f);
    const _S56 : vec3<f32> = vec3<f32>(0.0f, 0.0f, 0.0f);
    var last_0 : vec3<f32> = max(vec3<f32>(frame_0.probe_counts_0.xyz) - _S55, _S56);
    var grid_2 : vec3<f32> = clamp((world_position_8 - frame_0.probe_origin_0.xyz) * frame_0.probe_inv_spacing_0.xyz, _S56, last_0);
    var base_2 : vec3<f32> = floor(grid_2);
    var f_0 : vec3<f32> = grid_2 - base_2;
    var _S57 : vec3<u32> = vec3<u32>(base_2);
    var _S58 : vec3<u32> = vec3<u32>(min(base_2 + _S55, last_0));
    var _S59 : u32 = _S57.x;
    var _S60 : u32 = _S57.y;
    var _S61 : u32 = _S57.z;
    var _S62 : u32 = _S58.x;
    ...
    var _S65 : u32 = _S58.z;
    var _S66 : f32 = f_0.y;
    var cell_2 : GpuProbe_0 = lerp_probe_0(lerp_probe_0(lerp_probe_0(probe_at_0(vec3<u32>(_S59, _S60, _S61)), probe_at_0(vec3<u32>(_S62, _S60, _S61)), _S63), lerp_probe_0(probe_at_0(vec3<u32>(_S59, _S64, _S61)), probe_at_0(vec3<u32>(_S62, _S64, _S61)), _S63), _S66), lerp_probe_0(lerp_probe_0(probe_at_0(vec3<u32>(_S59, _S60, _S65)), probe_at_0(vec3<u32>(_S62, _S60, _S65)), _S63), lerp_probe_0(probe_at_0(vec3<u32>(_S59, _S64, _S65)), probe_at_0(vec3<u32>(_S62, _S64, _S65)), _S63), _S66), f_0.z);
    var basis_2 : vec4<f32> = vec4<f32>(normal_3, 1.0f);
    return max(vec3<f32>(dot(cell_2.sh_r_0, basis_2), dot(cell_2.sh_g_0, basis_2), dot(cell_2.sh_b_0, basis_2)), _S56);
}
...
fn fog_exp_neg_0( x_0 : f32) -> f32
{
    ...
    var _S67 : f32 = - (clamped_0 - n_0 * 0.693115234375f - n_0 * 0.00003194618329871f);
    ...
    for(;;)
    {
        ...
        var _S68 : f32 = kernel_0 * _S67 + FOG_KERNEL_0[term_0];
...
fn fog_one_minus_exp_over_0( d_0 : f32) -> f32
{
    if((abs(d_0)) < 0.125f)
    {
        ...
        for(;;)
        {
            ...
            var _S70 : f32 = series_0 * _S69 + FOG_RATIO_KERNEL_0[term_2];
...
@fragment
fn fragmentMain( _S71 : pixelInput_0, @builtin(position) position_3 : vec4<f32>) -> FragmentOutput_0
{
    var normal_4 : vec3<f32> = normalize(_S71.world_normal_1);
    if((frame_0.ambient_0.w) >= 1.5f)
    {
    ...
    var _S73 : vec3<f32> = geometric_normal_of_0(_S71.world_position_9, normal_4);
    var _S74 : GpuMaterial_std430_0 = materials_0[_S71.material_3];
    var uv_3 : vec2<f32>;
    if((_S74.tiling_0) == u32(1))
    {
        uv_3 = physical_tile_uv_0(_S71.world_position_9, normal_4, _S74.tile_metres_0);
    }
    else
    {
        uv_3 = _S71.uv_2;
    }
    var _S75 : vec3<f32> = vec3<f32>(uv_3, f32(_S74.base_color_texture_0));
    var albedo_0 : vec4<f32> = _S71.color_3 * _S74.base_color_0 * (textureSample((base_color_textures_0), (base_color_sampler_0), ((_S75)).xy, i32(((_S75)).z)));
    var metallic_1 : f32 = saturate(_S74.metallic_0);
    var roughness_3 : f32 = clamp(_S74.roughness_0, 0.04500000178813934f, 1.0f);
    var alpha_0 : f32 = roughness_3 * roughness_3;
    var _S76 : f32 = alpha_0 * alpha_0;
    var _S77 : vec3<f32> = albedo_0.xyz;
    var f0_2 : vec3<f32> = mix(vec3<f32>(0.03999999910593033f, 0.03999999910593033f, 0.03999999910593033f), _S77, vec3<f32>(metallic_1));
    var diffuse_albedo_0 : vec3<f32> = _S77 * vec3<f32>((1.0f - metallic_1));
    var _S78 : f32 = max(dot(normal_4, to_eye_0), 0.00009999999747379f);
    var _S79 : vec2<f32> = position_3.xy;
    var _S80 : u32 = froxel_of_0(_S79, (((vec4<f32>(_S71.world_position_9, 1.0f)) * (mat4x4<f32>(frame_0.view_proj_0.data_1[i32(0)][i32(0)], frame_0.view_proj_0.data_1[i32(1)][i32(0)], frame_0.view_proj_0.data_1[i32(2)][i32(0)], frame_0.view_proj_0.data_1[i32(3)][i32(0)], frame_0.view_proj_0.data_1[i32(0)][i32(1)], frame_0.view_proj_0.data_1[i32(1)][i32(1)], frame_0.view_proj_0.data_1[i32(2)][i32(1)], frame_0.view_proj_0.data_1[i32(3)][i32(1)], frame_0.view_proj_0.data_1[i32(0)][i32(2)], frame_0.view_proj_0.data_1[i32(1)][i32(2)], frame_0.view_proj_0.data_1[i32(2)][i32(2)], frame_0.view_proj_0.data_1[i32(3)][i32(2)], frame_0.view_proj_0.data_1[i32(0)][i32(3)], frame_0.view_proj_0.data_1[i32(1)][i32(3)], frame_0.view_proj_0.data_1[i32(2)][i32(3)], frame_0.view_proj_0.data_1[i32(3)][i32(3)])))).w);
    var base_3 : u32 = _S80 * u32(17);
    var _S81 : u32 = min(cluster_lights_0[base_3], u32(16));
    const _S82 : vec3<f32> = vec3<f32>(0.0f, 0.0f, 0.0f);
    var slot_0 : u32 = u32(0);
    var direct_0 : vec3<f32> = _S82;
    var gloss_0 : vec3<f32> = _S82;
    for(;;)
    {
        if(slot_0 < _S81)
        {
        ...
        var _S83 : GpuLight_std430_0 = lights_0[cluster_lights_0[base_3 + u32(1) + slot_0]];
        var _S84 : u32 = _S83.kind_0;
        var _S85 : bool = (_S83.kind_0) == u32(0);
        var to_light_7 : vec3<f32>;
        var reach_0 : f32;
        if(_S85)
        {
            to_light_7 = normalize(_S83.direction_0.xyz);
            reach_0 = 1.0f;
        }
        else
        {
            var offset_0 : vec3<f32> = _S83.position_1.xyz - _S71.world_position_9;
            var distance_2 : f32 = length(offset_0);
            var to_light_8 : vec3<f32> = offset_0 / vec3<f32>(max(distance_2, 9.99999997475242708e-07f));
            var reach_1 : f32 = punctual_falloff_0(distance_2, _S83.position_1.w);
            if(_S84 == u32(2))
            {
                reach_0 = reach_1 * spot_cone_0(to_light_8, _S83.direction_0.xyz, _S83.direction_0.w, _S83.cos_inner_0);
            }
            else
            {
                reach_0 = reach_1;
        ...
        var _S86 : f32 = max(n_dot_l_5, 0.0f);
        var half_vector_0 : vec3<f32> = normalize(to_light_7 + to_eye_0);
        var specular_0 : vec3<f32> = ggx_lobe_0(_S76, f0_2, _S86, _S78, max(dot(normal_4, half_vector_0), 0.0f), max(dot(to_eye_0, half_vector_0), 0.0f)) * vec3<f32>(_S86);
        var reach_2 : f32;
        if(_S85)
        {
            reach_2 = sun_visibility_0(_S71.world_position_9, to_light_7, n_dot_l_5, _S73, _S79);
        }
        else
        {
            if(_S84 == u32(1))
            {
                var _S87 : u32 = _S83.shadow_tile_0;
                if((_S83.shadow_tile_0) <= u32(8))
                {
                    var _S88 : f32 = point_visibility_0(&(_S83), _S87, _S71.world_position_9, to_light_7, n_dot_l_5, _S73, _S79);
            ...
            {
                var _S89 : u32 = _S83.shadow_tile_0;
                if((_S83.shadow_tile_0) < u32(14))
                {
                    var _S90 : f32 = spot_visibility_0(&(_S83), _S89, _S71.world_position_9, to_light_7, n_dot_l_5, _S73, _S79);
        ...
        var _S91 : vec3<f32> = _S83.color_1.xyz;
        var direct_1 : vec3<f32> = direct_0 + _S91 * vec3<f32>((_S86 * reach_2));
        var gloss_1 : vec3<f32> = gloss_0 + _S91 * (specular_0 * vec3<f32>(reach_2));
        slot_0 = slot_0 + u32(1);
        direct_0 = direct_1;
        gloss_0 = gloss_1;
    }
    var gloss_2 : vec3<f32> = gloss_0 * specular_compensation_0(f0_2, _S78, roughness_3);
    ...
    var _S92 : vec3<i32> = vec3<i32>(min(vec2<i32>(_S79), vec2<i32>(i32(occlusion_width_0), i32(occlusion_height_0)) - vec2<i32>(i32(1))), i32(0));
    var lit_1 : vec3<f32> = diffuse_albedo_0 * ((frame_0.ambient_0.xyz + sky_irradiance_0(normal_4) + probe_irradiance_0(_S71.world_position_9, normal_4)) * vec3<f32>((textureLoad((ambient_occlusion_0), ((_S92)).xy, ((_S92)).z).x)) + direct_0) + gloss_2;
    var _S93 : vec3<f32> = emissive_of_0(&(_S74));
