...
#line 685 "shaders/mesh_cluster.slang"
...
#line 1415
            float4 _S19 = float4((float4(vertex_0.position_0) ).xyz, 1.0f);

#line 1415
            float4 world_0 = (((_S19) * (_S17)));
...
#line 1415
            (&output_0)->previous_clip_position_0 = ((((((_S19) * (matrix<float,int(4),int(4)> (_S13->previous_transform_0.data_0[int(0)][int(0)], _S13->previous_transform_0.data_0[int(1)][int(0)], _S13->previous_transform_0.data_0[int(2)][int(0)], _S13->previous_transform_0.data_0[int(3)][int(0)], _S13->previous_transform_0.data_0[int(0)][int(1)], _S13->previous_transform_0.data_0[int(1)][int(1)], _S13->previous_transform_0.data_0[int(2)][int(1)], _S13->previous_transform_0.data_0[int(3)][int(1)], _S13->previous_transform_0.data_0[int(0)][int(2)], _S13->previous_transform_0.data_0[int(1)][int(2)], _S13->previous_transform_0.data_0[int(2)][int(2)], _S13->previous_transform_0.data_0[int(3)][int(2)], _S13->previous_transform_0.data_0[int(0)][int(3)], _S13->previous_transform_0.data_0[int(1)][int(3)], _S13->previous_transform_0.data_0[int(2)][int(3)], _S13->previous_transform_0.data_0[int(3)][int(3)]))))) * (matrix<float,int(4),int(4)> ((&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(0)][int(0)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(1)][int(0)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(2)][int(0)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(3)][int(0)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(0)][int(1)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(1)][int(1)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(2)][int(1)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(3)][int(1)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(0)][int(2)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(1)][int(2)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(2)][int(2)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(3)][int(2)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(0)][int(3)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(1)][int(3)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(2)][int(3)], (&kernelContext_4)->frame_0->previous_view_proj_0.data_1[int(3)][int(3)]))));
...
#line 1444
    ...
    uint index_0 = (&kernelContext_7)->draw_0->cluster_base_0 + _S34;

#line 1447
    thread ClusterSelect_0 _S37 = (&kernelContext_7)->cluster_select_0[index_0];
...
#line 1481
    if(_S45)
    {
        *((&kernelContext_7)->cluster_selection_0+index_0) = _S38;
...
#line 1507
        if(((_S48->flags_0) & 2U) != 0U)
        {

#line 1507
            t_2 = _S48->base_vertex_0;
...
#line 1507
        matrix<float,int(4),int(4)>  _S52 = matrix<float,int(4),int(4)> (_S48->transform_0.data_0[int(0)][int(0)], _S48->transform_0.data_0[int(1)][int(0)], _S48->transform_0.data_0[int(2)][int(0)], _S48->transform_0.data_0[int(3)][int(0)], _S48->transform_0.data_0[int(0)][int(1)], _S48->transform_0.data_0[int(1)][int(1)], _S48->transform_0.data_0[int(2)][int(1)], _S48->transform_0.data_0[int(3)][int(1)], _S48->transform_0.data_0[int(0)][int(2)], _S48->transform_0.data_0[int(1)][int(2)], _S48->transform_0.data_0[int(2)][int(2)], _S48->transform_0.data_0[int(3)][int(2)], _S48->transform_0.data_0[int(0)][int(3)], _S48->transform_0.data_0[int(1)][int(3)], _S48->transform_0.data_0[int(2)][int(3)], _S48->transform_0.data_0[int(3)][int(3)]);

#line 1507
        matrix<float,int(3),int(3)>  _S53 = normal_basis_0(matrix<float,int(3),int(3)> (_S52[int(0)].xyz, _S52[int(1)].xyz, _S52[int(2)].xyz));
...
#line 1507
            MeshVertex_natural_0 vertex_1 = (&kernelContext_8)->vertices_0[(&kernelContext_8)->cluster_vertices_0[cluster_4.vertex_offset_1 + v_1] + t_2 + _S51.vertex_base_0];

#line 1507
            float4 _S54 = float4((float4(vertex_1.position_0) ).xyz, 1.0f);

#line 1507
            float4 world_1 = (((_S54) * (_S52)));
...
#line 1507
            (&output_1)->world_normal_0 = ((((float4(vertex_1.normal_0) ).xyz) * (_S53)));
...
#line 1507
            (&output_1)->previous_clip_position_0 = ((((((_S54) * (matrix<float,int(4),int(4)> (_S48->previous_transform_0.data_0[int(0)][int(0)], _S48->previous_transform_0.data_0[int(1)][int(0)], _S48->previous_transform_0.data_0[int(2)][int(0)], _S48->previous_transform_0.data_0[int(3)][int(0)], _S48->previous_transform_0.data_0[int(0)][int(1)], _S48->previous_transform_0.data_0[int(1)][int(1)], _S48->previous_transform_0.data_0[int(2)][int(1)], _S48->previous_transform_0.data_0[int(3)][int(1)], _S48->previous_transform_0.data_0[int(0)][int(2)], _S48->previous_transform_0.data_0[int(1)][int(2)], _S48->previous_transform_0.data_0[int(2)][int(2)], _S48->previous_transform_0.data_0[int(3)][int(2)], _S48->previous_transform_0.data_0[int(0)][int(3)], _S48->previous_transform_0.data_0[int(1)][int(3)], _S48->previous_transform_0.data_0[int(2)][int(3)], _S48->previous_transform_0.data_0[int(3)][int(3)]))))) * (matrix<float,int(4),int(4)> ((&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(0)][int(0)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(1)][int(0)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(2)][int(0)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(3)][int(0)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(0)][int(1)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(1)][int(1)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(2)][int(1)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(3)][int(1)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(0)][int(2)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(1)][int(2)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(2)][int(2)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(3)][int(2)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(0)][int(3)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(1)][int(3)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(2)][int(3)], (&kernelContext_8)->frame_0->previous_view_proj_0.data_1[int(3)][int(3)]))));
