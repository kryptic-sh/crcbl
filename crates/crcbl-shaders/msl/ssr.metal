...
#line 372
[[fragment]] pixelOutput_0 fragmentMain(pixelInput_0 _S16 [[stage_in]], float4 position_0 [[position]], depth2d<float, access::sample> scene_depth_1 [[texture(0)]], texture2d<float, access::sample> scene_color_1 [[texture(1)]], texture2d<float, access::sample> reflectivity_1 [[texture(2)]], SsrParams_natural_0 constant* camera_1 [[buffer(0)]])
{
...
#line 386
    float4 lit_0 = ((scene_color_1).read(vec<uint,2>(((_S20)).xy), uint(((_S20)).z)));
...
#line 547
    pixelOutput_0 _S54 = { float4(lit_0.xyz + reflection_0, lit_0.w) };
...
#line 256
[[vertex]] vertexMain_Result_0 vertexMain(uint index_0 [[vertex_id]], depth2d<float, access::sample> scene_depth_2 [[texture(0)]], texture2d<float, access::sample> scene_color_2 [[texture(1)]], texture2d<float, access::sample> reflectivity_2 [[texture(2)]], SsrParams_natural_0 constant* camera_2 [[buffer(0)]])
{
