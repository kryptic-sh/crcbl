...
#line 3873
float probe_chebyshev_0(uint index_6, float3 probe_position_0, float3 world_position_10, float3 normal_7, KernelContext_0 thread* kernelContext_27)
{
...
#line 3895
float probe_weight_0(uint index_7, float3 probe_position_1, float3 world_position_11, float3 normal_8, KernelContext_0 thread* kernelContext_28)
{

#line 3895
    float _S181 = probe_chebyshev_0(index_7, probe_position_1, world_position_11, normal_8, kernelContext_28);

    return max(_S181, 0.00009999999747379f);
}
...
#line 3955
WeightedProbe_0 probe_corner_0(uint level_2, uint3 cell_2, float3 origin_1, float3 spacing_0, float3 world_position_12, float3 normal_9, KernelContext_0 thread* kernelContext_29)
{

#line 3956
    uint _S182 = probe_row_0(level_2, cell_2, kernelContext_29);


    GpuProbe_natural_0 stored_0 = kernelContext_29->probes_0[_S182];

#line 3959
    float _S183 = probe_weight_0(_S182, origin_1 + float3(cell_2) * spacing_0, world_position_12, normal_9, kernelContext_29);
...
#line 3963
    float4 _S184 = float4(_S183) ;
    (&(&corner_2)->sh_0)->sh_r_0 = float4(stored_0.sh_r_0)  * _S184;
    (&(&corner_2)->sh_0)->sh_g_0 = float4(stored_0.sh_g_0)  * _S184;
    (&(&corner_2)->sh_0)->sh_b_0 = float4(stored_0.sh_b_0)  * _S184;
    (&corner_2)->weight_3 = _S183;
    return corner_2;
}
...
WeightedProbe_0 lerp_probe_0(const WeightedProbe_0 thread* a_1, const WeightedProbe_0 thread* b_0, float t_1)
{
    ...
    float4 _S185 = float4(t_1) ;

#line 3942
    (&(&blended_0)->sh_0)->sh_r_0 = mix((&a_1->sh_0)->sh_r_0, (&b_0->sh_0)->sh_r_0, _S185);
    (&(&blended_0)->sh_0)->sh_g_0 = mix((&a_1->sh_0)->sh_g_0, (&b_0->sh_0)->sh_g_0, _S185);
    (&(&blended_0)->sh_0)->sh_b_0 = mix((&a_1->sh_0)->sh_b_0, (&b_0->sh_0)->sh_b_0, _S185);
...
#line 4027
float3 probe_level_irradiance_0(uint level_3, float3 world_position_13, float3 normal_10, KernelContext_0 thread* kernelContext_30)
{

#line 4027
    float3 _S186 = float3(1.0f) ;

#line 4032
    float3 _S187 = float3(0.0f, 0.0f, 0.0f);

#line 4032
    float3 last_1 = max(float3(kernelContext_30->frame_0->probe_counts_0.xyz) - _S186, _S187);



    float3 origin_2 = kernelContext_30->frame_0->probe_level_origin_0[level_3].xyz;
    float3 inv_0 = kernelContext_30->frame_0->probe_level_inv_spacing_0[level_3].xyz;
    float3 grid_0 = clamp((world_position_13 - origin_2) * inv_0, _S187, last_1);
    float3 base_2 = floor(grid_0);
    float3 f_0 = grid_0 - base_2;

    uint3 _S188 = uint3(base_2);



    uint3 _S189 = uint3(min(base_2 + _S186, last_1));
...
#line 4052
    float3 spacing_1 = float3(_S191, _S193, _S195);
...
#line 4061
    WeightedProbe_0 _S199 = probe_corner_0(level_3, uint3(_S196, _S197, _S198), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);
    uint _S200 = _S189.x;

#line 4062
    WeightedProbe_0 _S201 = probe_corner_0(level_3, uint3(_S200, _S197, _S198), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);

#line 4062
    float _S202 = f_0.x;

#line 4062
    thread WeightedProbe_0 _S203 = _S199;

#line 4062
    thread WeightedProbe_0 _S204 = _S201;

#line 4062
    WeightedProbe_0 _S205 = lerp_probe_0(&_S203, &_S204, _S202);
    uint _S206 = _S189.y;

#line 4063
    WeightedProbe_0 _S207 = probe_corner_0(level_3, uint3(_S196, _S206, _S198), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);

#line 4063
    WeightedProbe_0 _S208 = probe_corner_0(level_3, uint3(_S200, _S206, _S198), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);
...
#line 4063
    WeightedProbe_0 _S211 = lerp_probe_0(&_S209, &_S210, _S202);

    uint _S212 = _S189.z;

#line 4065
    WeightedProbe_0 _S213 = probe_corner_0(level_3, uint3(_S196, _S197, _S212), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);

#line 4065
    WeightedProbe_0 _S214 = probe_corner_0(level_3, uint3(_S200, _S197, _S212), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);

#line 4065
    thread WeightedProbe_0 _S215 = _S213;

#line 4065
    thread WeightedProbe_0 _S216 = _S214;

#line 4065
    WeightedProbe_0 _S217 = lerp_probe_0(&_S215, &_S216, _S202);

#line 4065
    WeightedProbe_0 _S218 = probe_corner_0(level_3, uint3(_S196, _S206, _S212), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);

#line 4065
    WeightedProbe_0 _S219 = probe_corner_0(level_3, uint3(_S200, _S206, _S212), origin_2, spacing_1, world_position_13, normal_10, kernelContext_30);

#line 4065
    thread WeightedProbe_0 _S220 = _S218;

#line 4065
    thread WeightedProbe_0 _S221 = _S219;

#line 4065
    WeightedProbe_0 _S222 = lerp_probe_0(&_S220, &_S221, _S202);
...
#line 4069
    thread WeightedProbe_0 _S224 = _S205;

#line 4069
    thread WeightedProbe_0 _S225 = _S211;

#line 4069
    WeightedProbe_0 _S226 = lerp_probe_0(&_S224, &_S225, _S223);

#line 4069
    thread WeightedProbe_0 _S227 = _S217;

#line 4069
    thread WeightedProbe_0 _S228 = _S222;

#line 4069
    WeightedProbe_0 _S229 = lerp_probe_0(&_S227, &_S228, _S223);

    float _S230 = f_0.z;

#line 4071
    thread WeightedProbe_0 _S231 = _S226;
...
#line 4071
    ...
    return max(float3(dot(_S233.sh_0.sh_r_0, basis_7), dot(_S233.sh_0.sh_g_0, basis_7), dot(_S233.sh_0.sh_b_0, basis_7)) / float3(_S233.weight_3) , _S187);
}


#line 4161
float3 probe_irradiance_0(float3 world_position_14, float3 normal_11, KernelContext_0 thread* kernelContext_31)
{

#line 4169
    float2 pick_0 = probe_level_of_0(probe_level_reach_0(world_position_14, kernelContext_31->frame_0->probe_level_origin_0[int(0)].xyz, kernelContext_31->frame_0->probe_level_inv_spacing_0[int(0)].xyz, max(float3(kernelContext_31->frame_0->probe_counts_0.xyz) - float3(1.0f) , float3(0.0f, 0.0f, 0.0f))), clamp(kernelContext_31->frame_0->probe_levels_0.x, 1U, 4U));
    uint level_4 = uint(pick_0.x);
    float share_0 = pick_0.y;

#line 4171
    float3 _S234 = probe_level_irradiance_0(level_4, world_position_14, normal_11, kernelContext_31);
...
#line 4175
    float3 _S235 = probe_level_irradiance_0(level_4 + 1U, world_position_14, normal_11, kernelContext_31);

    return _S235 * float3((1.0f - share_0))  + _S234 * float3(share_0) ;
}
...
#line 4623
    float3 _S236 = float3(visibility_2) ;

#line 4629
    return min(float3(1.0f) , max(_S236, ((_S236 * (float3(2.04040002822875977f)  * albedo_0 - float3(0.33239999413490295f) ) + (float3(-4.79510021209716797f)  * albedo_0 + float3(0.64170002937316895f) )) * _S236 + (float3(2.75519990921020508f)  * albedo_0 + float3(0.69029998779296875f) )) * _S236));
}
...
float fog_exp_neg_0(float x_0)
{
    ...
    float _S237 = - (clamped_0 - n_0 * 0.693115234375f - n_0 * 0.00003194618329871f);
...
#line 2502
        ...
        float _S238 = kernel_0 * _S237 + FOG_KERNEL_0[term_0];
...
#line 2525
            ...
            float _S240 = series_0 * _S239 + FOG_RATIO_KERNEL_0[term_2];
...
#line 4665
    (&kernelContext_32)->draw_0 = draw_3;

#line 4665
    (&kernelContext_32)->visible_instances_0 = visible_instances_3;

#line 4665
    (&kernelContext_32)->instances_0 = instances_3;

#line 4665
    (&kernelContext_32)->meshes_0 = meshes_3;

#line 4665
    (&kernelContext_32)->frame_0 = frame_5;

#line 4665
    (&kernelContext_32)->vertices_0 = vertices_3;

#line 4665
    (&kernelContext_32)->ambient_occlusion_0 = ambient_occlusion_3;

#line 4665
    (&kernelContext_32)->materials_0 = materials_3;

#line 4665
    (&kernelContext_32)->normal_textures_0 = normal_textures_3;

#line 4665
    (&kernelContext_32)->base_color_sampler_0 = base_color_sampler_3;

#line 4665
    (&kernelContext_32)->base_color_textures_0 = base_color_textures_3;

#line 4665
    (&kernelContext_32)->cluster_lights_0 = cluster_lights_3;

#line 4665
    (&kernelContext_32)->specular_dfg_0 = specular_dfg_3;

#line 4665
    (&kernelContext_32)->lights_0 = lights_3;

#line 4665
    (&kernelContext_32)->ltc_matrix_0 = ltc_matrix_3;
...
#line 4665
    (&kernelContext_32)->contact_shadow_0 = contact_shadow_3;

#line 4665
    (&kernelContext_32)->probes_0 = probes_3;

#line 4665
    (&kernelContext_32)->probe_visibility_0 = probe_visibility_3;

#line 4677
    float3 vertex_normal_0 = normalize(_S241.world_normal_1);

#line 4682
    float2 motion_1 = motion_vector_0(_S241.clip_position_1, _S241.previous_clip_position_1);
...
#line 4700
        float4 _S242 = occlusion_at_0(position_5.xy, &kernelContext_32);



        (&bent_0)->lit_0 = float4(_S242.yzw, 1.0f);
...
#line 4754
        float4 _S243 = occlusion_at_0(position_5.xy, &kernelContext_32);


        float value_1 = _S243.x;
...
#line 4765
    ...
    if((frame_5->ambient_0.w) >= 1.5f)
    {
        ...
        (&tint_0)->lit_0 = float4(_S241.color_3.xyz, 1.0f);
...
#line 4782
    thread GpuMaterial_natural_0 _S244 = (&kernelContext_32)->materials_0[_S241.material_5];

#line 4782
    float2 uv_3;

#line 4807
    if(((&_S244)->tiling_0) == 1U)
    {

#line 4807
        uv_3 = physical_tile_uv_0(_S241.world_position_15, vertex_normal_0, (&_S244)->tile_metres_0);
...
#line 4807
    uint _S245 = normal_layer_0(&_S244);

#line 4807
    thread VertexOutput_0 _S246;

#line 4807
    (&_S246)->position_3 = position_5;

#line 4807
    (&_S246)->world_position_1 = _S241.world_position_15;

#line 4807
    (&_S246)->world_normal_0 = _S241.world_normal_1;

#line 4807
    (&_S246)->color_2 = _S241.color_3;

#line 4807
    (&_S246)->material_2 = _S241.material_5;

#line 4807
    (&_S246)->uv_0 = _S241.uv_2;

#line 4807
    (&_S246)->clip_position_0 = _S241.clip_position_1;

#line 4807
    (&_S246)->previous_clip_position_0 = _S241.previous_clip_position_1;

#line 4807
    (&_S246)->world_tangent_0 = _S241.world_tangent_1;

#line 4807
    (&_S246)->frame_3 = _S241.frame_4;

#line 4807
    float3 _S247 = shading_normal_of_0(_S245, (&_S244)->normal_scale_0, &_S246, vertex_normal_0, uv_3, &kernelContext_32);
...
#line 4816
        float3 _S248 = float3(0.5f) ;

#line 4828
        (&normals_0)->lit_0 = float4(_S247 * _S248 + _S248, 1.0f);
...
#line 4834
    ...
    float3 to_eye_1 = normalize((&kernelContext_32)->frame_0->camera_position_0.xyz - _S241.world_position_15);



    float3 _S249 = geometric_normal_of_0(_S241.world_position_15, vertex_normal_0);

#line 4843
    uint _S250 = base_color_layer_0(&_S244);

#line 4858
    float3 _S251 = float3(uv_3, float(_S250));
    float4 albedo_1 = _S241.color_3 * float4((&_S244)->base_color_0)  * (((&kernelContext_32)->base_color_textures_0).sample(((&kernelContext_32)->base_color_sampler_0), ((_S251)).xy, uint(((_S251)).z)));

#line 4865
    float metallic_1 = saturate((&_S244)->metallic_0);
    float roughness_2 = clamp((&_S244)->roughness_0, 0.04500000178813934f, 1.0f);
    float alpha_0 = roughness_2 * roughness_2;
    float _S252 = alpha_0 * alpha_0;

#line 4874
    float3 _S253 = albedo_1.xyz;

#line 4874
    float3 f0_2 = mix(float3(0.03999999910593033f, 0.03999999910593033f, 0.03999999910593033f), _S253, float3(metallic_1) );
    float3 diffuse_albedo_0 = _S253 * float3((1.0f - metallic_1)) ;

#line 4881
    float _S254 = max(dot(_S247, to_eye_1), 0.00009999999747379f);

#line 4891
    float2 _S255 = position_5.xy;

#line 4891
    uint _S256 = froxel_of_0(_S255, (((float4(_S241.world_position_15, 1.0f)) * (matrix<float,int(4),int(4)> ((&kernelContext_32)->frame_0->view_proj_0.data_1[int(0)][int(0)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(1)][int(0)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(2)][int(0)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(3)][int(0)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(0)][int(1)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(1)][int(1)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(2)][int(1)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(3)][int(1)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(0)][int(2)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(1)][int(2)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(2)][int(2)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(3)][int(2)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(0)][int(3)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(1)][int(3)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(2)][int(3)], (&kernelContext_32)->frame_0->view_proj_0.data_1[int(3)][int(3)])))).w, &kernelContext_32);

#line 4891
    uint base_3 = _S256 * 17U;

#line 4896
    uint _S257 = min((&kernelContext_32)->cluster_lights_0[base_3], 16U);

#line 4896
    TableTap_0 _S258 = table_tap_0(_S254, roughness_2, &kernelContext_32);

#line 4896
    thread TableTap_0 _S259 = _S258;

#line 4896
    float2 _S260 = dfg_at_0(&_S259, &kernelContext_32);
...
#line 4905
    float3 _S263 = f0_2 * float3(_S261)  + float3(_S262) ;

#line 4911
    float3 _S264 = float3(0.0f, 0.0f, 0.0f);

#line 4911
    uint slot_0 = 0U;

#line 4911
    float3 direct_0 = _S264;

#line 4911
    float3 gloss_0 = _S264;
...
#line 4913
        thread GpuLight_natural_0 _S265 = (&kernelContext_32)->lights_0[(&kernelContext_32)->cluster_lights_0[base_3 + 1U + slot_0]];

#line 4913
        uint _S266 = (&_S265)->kind_0;

#line 4922
        bool _S267 = ((&_S265)->kind_0) == 0U;
...
#line 4922
            to_light_7 = normalize((float4((&_S265)->direction_0) ).xyz);
...
#line 4927
                float4 _S268 = float4((&_S265)->position_0) ;

#line 4935
                float3 offset_0 = _S268.xyz - _S241.world_position_15;
                float distance_3 = length(offset_0);

                float _S269 = range_window_0(distance_3, _S268.w);
...
#line 4927
                float4 _S270 = float4((&_S265)->position_0) ;

#line 4942
                float3 offset_1 = _S270.xyz - _S241.world_position_15;
                float distance_4 = length(offset_1);
                float3 to_light_8 = offset_1 / float3(max(distance_4, 9.99999997475242708e-07f)) ;
                float reach_3 = punctual_falloff_0(distance_4, _S270.w);
                if(_S266 == 2U)
                {

#line 4946
                    float4 _S271 = float4((&_S265)->direction_0) ;

#line 4946
                    reach_2 = reach_3 * spot_cone_0(to_light_8, _S271.xyz, _S271.w, (&_S265)->cos_inner_0);
...
#line 4955
        float n_dot_l_5 = dot(_S247, to_light_7);
...
#line 4968
            rect_corners_0(&_S265, _S241.world_position_15, &corners_2);

            matrix<float,int(3),int(3)>  to_local_0 = ltc_shading_frame_0(_S247, to_eye_1, _S254);

#line 4970
            thread array<float3, int(4)> _S272 = corners_2;

#line 4970
            float _S273 = ltc_irradiance_0(to_local_0, &_S272);

#line 4970
            thread TableTap_0 _S274 = _S258;

#line 4970
            float4 _S275 = ltc_at_0(&_S274, &kernelContext_32);

            matrix<float,int(3),int(3)>  _S276 = (((to_local_0) * (ltc_transform_0(_S275))));

#line 4972
            thread array<float3, int(4)> _S277 = corners_2;

#line 4972
            float _S278 = ltc_irradiance_0(_S276, &_S277);
            float3 _S279 = float3(_S278)  * _S263;
...
#line 4978
            float _S280 = max(n_dot_l_5, 0.0f);

#line 4985
            float3 half_vector_0 = normalize(to_light_7 + to_eye_1);

#line 4993
            float3 specular_1 = ggx_lobe_0(_S252, f0_2, _S280, _S254, max(dot(_S247, half_vector_0), 0.0f), max(dot(to_eye_1, half_vector_0), 0.0f)) * float3(_S280) ;
...
#line 5019
            float _S281 = sun_visibility_0(_S241.world_position_15, to_light_7, n_dot_l_5, _S249, _S255, &kernelContext_32);

#line 5019
            float _S282 = contact_at_0(_S255, &kernelContext_32);
...
#line 5031
                uint _S283 = (&_S265)->shadow_tile_0;

#line 5043
                if(((&_S265)->shadow_tile_0) <= 8U)
                {

#line 5043
                    float _S284 = point_visibility_0(&_S265, _S283, _S241.world_position_15, to_light_7, n_dot_l_5, _S249, _S255, &kernelContext_32);
...
#line 5031
                uint _S285 = (&_S265)->shadow_tile_0;

#line 5049
                if(((&_S265)->shadow_tile_0) < 14U)
                {

#line 5049
                    float _S286 = spot_visibility_0(&_S265, _S285, _S241.world_position_15, to_light_7, n_dot_l_5, _S249, _S255, &kernelContext_32);

#line 5049
                    reach_4 = reach_2 * _S286;
...
#line 5057
        float3 _S287 = (float4((&_S265)->color_0) ).xyz;

#line 5057
        float3 direct_1 = direct_0 + _S287 * float3((diffuse_0 * reach_4)) ;
        float3 gloss_1 = gloss_0 + _S287 * (specular_2 * float3(reach_4) );
...
#line 5072
    float3 gloss_2 = gloss_0 * specular_compensation_0(f0_2, _S261 + _S262);

#line 5072
    float4 _S288 = occlusion_at_0(_S255, &kernelContext_32);

#line 5091
    float occluded_0 = _S288.x;

#line 5100
    float3 bent_normal_0 = bent_normal_at_0(_S288, _S247);

#line 5123
    float3 _S289 = frame_5->ambient_0.xyz;

#line 5123
    float3 _S290 = sky_irradiance_0(bent_normal_0, &kernelContext_32);

#line 5123
    float3 _S291 = _S289 + _S290;

#line 5123
    float3 _S292 = probe_irradiance_0(_S241.world_position_15, bent_normal_0, &kernelContext_32);

#line 5159
    float3 lit_1 = diffuse_albedo_0 * ((_S291 + _S292) * multi_bounce_occlusion_0(occluded_0, diffuse_albedo_0) + direct_0) + gloss_2;

#line 5159
    float3 _S293 = emissive_of_0(&_S244);

#line 5195
    float fog_survives_0 = fog_transmittance_0(fog_optical_depth_0((&kernelContext_32)->frame_0->fog_params_0.x, (&kernelContext_32)->frame_0->fog_params_0.y, (&kernelContext_32)->frame_0->camera_position_0.y - (&kernelContext_32)->frame_0->fog_params_0.z, _S241.world_position_15.y - (&kernelContext_32)->frame_0->fog_params_0.z, length((&kernelContext_32)->frame_0->camera_position_0.xyz - _S241.world_position_15)));
    ...
    (&output_2)->lit_0 = float4((lit_1 + _S293) * float3(fog_survives_0)  + (&kernelContext_32)->frame_0->fog_color_0.xyz * float3((1.0f - fog_survives_0)) , albedo_1.w);
...
#line 5282
    (&kernelContext_33)->draw_0 = draw_4;

#line 5282
    (&kernelContext_33)->visible_instances_0 = visible_instances_4;

#line 5282
    (&kernelContext_33)->instances_0 = instances_4;

#line 5282
    (&kernelContext_33)->meshes_0 = meshes_4;

#line 5282
    (&kernelContext_33)->frame_0 = frame_7;

#line 5282
    (&kernelContext_33)->vertices_0 = vertices_4;

#line 5282
    (&kernelContext_33)->ambient_occlusion_0 = ambient_occlusion_4;

#line 5282
    (&kernelContext_33)->materials_0 = materials_4;

#line 5282
    (&kernelContext_33)->normal_textures_0 = normal_textures_4;

#line 5282
    (&kernelContext_33)->base_color_sampler_0 = base_color_sampler_4;

#line 5282
    (&kernelContext_33)->base_color_textures_0 = base_color_textures_4;

#line 5282
    (&kernelContext_33)->cluster_lights_0 = cluster_lights_4;

#line 5282
    (&kernelContext_33)->specular_dfg_0 = specular_dfg_4;

#line 5282
    (&kernelContext_33)->lights_0 = lights_4;

#line 5282
    (&kernelContext_33)->ltc_matrix_0 = ltc_matrix_4;
...
#line 5282
    (&kernelContext_33)->contact_shadow_0 = contact_shadow_4;

#line 5282
    (&kernelContext_33)->probes_0 = probes_4;

#line 5282
    (&kernelContext_33)->probe_visibility_0 = probe_visibility_4;

#line 5287
    float3 vertex_normal_1 = normalize(_S294.world_normal_2);

#line 5287
    thread GpuMaterial_natural_0 _S295 = materials_4[_S294.material_6];

#line 5287
    float2 uv_5;

#line 5294
    if(((&_S295)->tiling_0) == 1U)
    {

#line 5294
        uv_5 = physical_tile_uv_0(_S294.world_position_16, vertex_normal_1, (&_S295)->tile_metres_0);
...
#line 5294
    uint _S296 = base_color_layer_0(&_S295);

#line 5299
    float3 _S297 = float3(uv_5, float(_S296));
    ...
    (&written_0)->albedo_2 = float4((_S294.color_4 * float4((&_S295)->base_color_0)  * (((&kernelContext_33)->base_color_textures_0).sample(((&kernelContext_33)->base_color_sampler_0), ((_S297)).xy, uint(((_S297)).z)))).xyz * float3((1.0f - saturate((&_S295)->metallic_0))) , 1.0f);

#line 5306
    float3 _S298 = float3(0.5f) ;
    (&written_0)->normal_12 = float4(vertex_normal_1 * _S298 + _S298, 1.0f);
    (&written_0)->world_0 = float4(_S294.world_position_16, 1.0f);
    return written_0;
}
...
#line 5309
    (&kernelContext_34)->draw_0 = draw_5;

#line 5309
    (&kernelContext_34)->visible_instances_0 = visible_instances_5;

#line 5309
    (&kernelContext_34)->instances_0 = instances_5;

#line 5309
    (&kernelContext_34)->meshes_0 = meshes_5;

#line 5309
    (&kernelContext_34)->frame_0 = frame_9;

#line 5309
    (&kernelContext_34)->vertices_0 = vertices_5;

#line 5309
    (&kernelContext_34)->ambient_occlusion_0 = ambient_occlusion_5;

#line 5309
    (&kernelContext_34)->materials_0 = materials_5;

#line 5309
    (&kernelContext_34)->normal_textures_0 = normal_textures_5;

#line 5309
    (&kernelContext_34)->base_color_sampler_0 = base_color_sampler_5;

#line 5309
    (&kernelContext_34)->base_color_textures_0 = base_color_textures_5;

#line 5309
    (&kernelContext_34)->cluster_lights_0 = cluster_lights_5;

#line 5309
    (&kernelContext_34)->specular_dfg_0 = specular_dfg_5;

#line 5309
    (&kernelContext_34)->lights_0 = lights_5;

#line 5309
    (&kernelContext_34)->ltc_matrix_0 = ltc_matrix_5;
...
#line 5309
    (&kernelContext_34)->contact_shadow_0 = contact_shadow_5;

#line 5309
    (&kernelContext_34)->probes_0 = probes_5;

#line 5309
    (&kernelContext_34)->probe_visibility_0 = probe_visibility_5;

#line 5309
    GpuInstance_natural_0 device* _S299 = instances_5+visible_instances_5[draw_5->base_0 + instance_id_1];

#line 1782
    GpuMesh_0 mesh_3 = meshes_5[draw_5->mesh_0];

#line 1790
    bool _S300 = ((_S299->flags_0) & 2U) != 0U;
...
#line 1791
        base_vertex_3 = _S299->base_vertex_0;
...
#line 1791
    MeshVertex_0 _S301 = load_vertex_0(index_8 + base_vertex_3, float4(mesh_3.uv_scale_u_0, mesh_3.uv_scale_v_0, mesh_3.uv_offset_u_0, mesh_3.uv_offset_v_0), &kernelContext_34);
...
#line 1804
        previous_base_0 = _S299->previous_base_vertex_0;
...
#line 1804
    float3 _S302 = load_position_0(index_8 + previous_base_0, &kernelContext_34);

#line 1804
    matrix<float,int(4),int(4)>  _S303 = matrix<float,int(4),int(4)> (_S299->transform_0.data_0[int(0)][int(0)], _S299->transform_0.data_0[int(1)][int(0)], _S299->transform_0.data_0[int(2)][int(0)], _S299->transform_0.data_0[int(3)][int(0)], _S299->transform_0.data_0[int(0)][int(1)], _S299->transform_0.data_0[int(1)][int(1)], _S299->transform_0.data_0[int(2)][int(1)], _S299->transform_0.data_0[int(3)][int(1)], _S299->transform_0.data_0[int(0)][int(2)], _S299->transform_0.data_0[int(1)][int(2)], _S299->transform_0.data_0[int(2)][int(2)], _S299->transform_0.data_0[int(3)][int(2)], _S299->transform_0.data_0[int(0)][int(3)], _S299->transform_0.data_0[int(1)][int(3)], _S299->transform_0.data_0[int(2)][int(3)], _S299->transform_0.data_0[int(3)][int(3)]);



    float4 world_1 = (((float4(_S301.position_1, 1.0f)) * (_S303)));

    thread VertexOutput_0 output_3;
    (&output_3)->position_3 = (((world_1) * (matrix<float,int(4),int(4)> ((&kernelContext_34)->frame_0->view_proj_0.data_1[int(0)][int(0)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(1)][int(0)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(2)][int(0)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(3)][int(0)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(0)][int(1)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(1)][int(1)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(2)][int(1)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(3)][int(1)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(0)][int(2)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(1)][int(2)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(2)][int(2)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(3)][int(2)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(0)][int(3)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(1)][int(3)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(2)][int(3)], (&kernelContext_34)->frame_0->view_proj_0.data_1[int(3)][int(3)]))));
    (&output_3)->world_position_1 = world_1.xyz;

#line 1818
    matrix<float,int(3),int(3)>  _S304 = matrix<float,int(3),int(3)> (_S303[int(0)].xyz, _S303[int(1)].xyz, _S303[int(2)].xyz);

#line 1818
    (&output_3)->world_normal_0 = (((_S301.basis_1.normal_0) * (normal_basis_0(_S304))));

#line 1824
    (&output_3)->world_tangent_0 = (((_S301.basis_1.tangent_1) * (_S304)));

#line 1824
    thread TangentFrame_0 _S305 = _S301.basis_1;

#line 1824
    uint _S306 = frame_word_0(mesh_3.flags_1, &_S305);
    (&output_3)->frame_3 = _S306;

#line 1825
    float4 _S307;

#line 1832
    if(((&kernelContext_34)->frame_0->ambient_0.w) >= 1.5f)
    {

#line 1832
        _S307 = float4(0.44999998807907104f, 0.44999998807907104f, 0.47999998927116394f, 1.0f);
...
#line 1831
    (&output_3)->color_2 = _S307;

#line 1838
    (&output_3)->material_2 = _S299->material_0;
    (&output_3)->uv_0 = _S301.uv0_0;

#line 1845
    (&output_3)->clip_position_0 = (&output_3)->position_3;
    (&output_3)->previous_clip_position_0 = ((((((float4(_S302, 1.0f)) * (matrix<float,int(4),int(4)> (_S299->previous_transform_0.data_0[int(0)][int(0)], _S299->previous_transform_0.data_0[int(1)][int(0)], _S299->previous_transform_0.data_0[int(2)][int(0)], _S299->previous_transform_0.data_0[int(3)][int(0)], _S299->previous_transform_0.data_0[int(0)][int(1)], _S299->previous_transform_0.data_0[int(1)][int(1)], _S299->previous_transform_0.data_0[int(2)][int(1)], _S299->previous_transform_0.data_0[int(3)][int(1)], _S299->previous_transform_0.data_0[int(0)][int(2)], _S299->previous_transform_0.data_0[int(1)][int(2)], _S299->previous_transform_0.data_0[int(2)][int(2)], _S299->previous_transform_0.data_0[int(3)][int(2)], _S299->previous_transform_0.data_0[int(0)][int(3)], _S299->previous_transform_0.data_0[int(1)][int(3)], _S299->previous_transform_0.data_0[int(2)][int(3)], _S299->previous_transform_0.data_0[int(3)][int(3)]))))) * (matrix<float,int(4),int(4)> ((&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(0)][int(0)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(1)][int(0)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(2)][int(0)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(3)][int(0)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(0)][int(1)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(1)][int(1)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(2)][int(1)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(3)][int(1)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(0)][int(2)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(1)][int(2)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(2)][int(2)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(3)][int(2)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(0)][int(3)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(1)][int(3)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(2)][int(3)], (&kernelContext_34)->frame_0->previous_view_proj_0.data_1[int(3)][int(3)]))));


    VertexOutput_0 _S308 = output_3;

#line 1849
    thread vertexMain_Result_0 _S309;

#line 1849
    (&_S309)->position_7 = _S308.position_3;

#line 1849
    (&_S309)->world_position_17 = _S308.world_position_1;

#line 1849
    (&_S309)->world_normal_3 = _S308.world_normal_0;

#line 1849
    (&_S309)->color_5 = _S308.color_2;

#line 1849
    (&_S309)->material_7 = _S308.material_2;

#line 1849
    (&_S309)->uv_6 = _S308.uv_0;

#line 1849
    (&_S309)->clip_position_3 = _S308.clip_position_0;

#line 1849
    (&_S309)->previous_clip_position_3 = _S308.previous_clip_position_0;

#line 1849
    (&_S309)->world_tangent_3 = _S308.world_tangent_0;

#line 1849
    (&_S309)->frame_8 = _S308.frame_3;
