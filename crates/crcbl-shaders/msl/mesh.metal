...
#line 1242
    matrix<float,int(4),int(4)>  _S147 = matrix<float,int(4),int(4)> (_S146->transform_0.data_0[int(0)][int(0)], _S146->transform_0.data_0[int(1)][int(0)], _S146->transform_0.data_0[int(2)][int(0)], _S146->transform_0.data_0[int(3)][int(0)], _S146->transform_0.data_0[int(0)][int(1)], _S146->transform_0.data_0[int(1)][int(1)], _S146->transform_0.data_0[int(2)][int(1)], _S146->transform_0.data_0[int(3)][int(1)], _S146->transform_0.data_0[int(0)][int(2)], _S146->transform_0.data_0[int(1)][int(2)], _S146->transform_0.data_0[int(2)][int(2)], _S146->transform_0.data_0[int(3)][int(2)], _S146->transform_0.data_0[int(0)][int(3)], _S146->transform_0.data_0[int(1)][int(3)], _S146->transform_0.data_0[int(2)][int(3)], _S146->transform_0.data_0[int(3)][int(3)]);

    float4 _S148 = float4((float4(vertex_0.position_0) ).xyz, 1.0f);

#line 1244
    float4 world_0 = (((_S148) * (_S147)));
...
#line 1254
    (&output_1)->world_normal_2 = ((((float4(vertex_0.normal_0) ).xyz) * (normal_basis_0(matrix<float,int(3),int(3)> (_S147[int(0)].xyz, _S147[int(1)].xyz, _S147[int(2)].xyz)))));
...
#line 1273
    ...
    (&output_1)->previous_clip_position_2 = ((((((_S148) * (matrix<float,int(4),int(4)> (_S146->previous_transform_0.data_0[int(0)][int(0)], _S146->previous_transform_0.data_0[int(1)][int(0)], _S146->previous_transform_0.data_0[int(2)][int(0)], _S146->previous_transform_0.data_0[int(3)][int(0)], _S146->previous_transform_0.data_0[int(0)][int(1)], _S146->previous_transform_0.data_0[int(1)][int(1)], _S146->previous_transform_0.data_0[int(2)][int(1)], _S146->previous_transform_0.data_0[int(3)][int(1)], _S146->previous_transform_0.data_0[int(0)][int(2)], _S146->previous_transform_0.data_0[int(1)][int(2)], _S146->previous_transform_0.data_0[int(2)][int(2)], _S146->previous_transform_0.data_0[int(3)][int(2)], _S146->previous_transform_0.data_0[int(0)][int(3)], _S146->previous_transform_0.data_0[int(1)][int(3)], _S146->previous_transform_0.data_0[int(2)][int(3)], _S146->previous_transform_0.data_0[int(3)][int(3)]))))) * (matrix<float,int(4),int(4)> ((&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(0)][int(0)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(1)][int(0)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(2)][int(0)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(3)][int(0)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(0)][int(1)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(1)][int(1)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(2)][int(1)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(3)][int(1)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(0)][int(2)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(1)][int(2)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(2)][int(2)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(3)][int(2)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(0)][int(3)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(1)][int(3)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(2)][int(3)], (&kernelContext_16)->frame_0->previous_view_proj_0.data_1[int(3)][int(3)]))));
