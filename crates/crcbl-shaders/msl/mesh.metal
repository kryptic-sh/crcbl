...
#line 400
    float4 albedo_0 = _S1.color_0 * float4(materials_1[_S1.material_0].base_color_0) ;


    float _S2 = max(dot(normal_1, to_light_0), 0.0f);

#line 403
    pixelOutput_0 _S3 = { float4(albedo_0.xyz * (frame_1->ambient_0.xyz + frame_1->light_color_0.xyz * float3(_S2) ) + frame_1->light_color_0.xyz * float3((pow(max(dot(normal_1, normalize(to_light_0 + normalize(frame_1->camera_position_0.xyz - _S1.world_position_0))), 0.0f), 32.0f) * (step(0.0f, _S2) * _S2) * 0.34999999403953552f)) , albedo_0.w) };
...
#line 369
    (&output_1)->material_3 = instance_0.material_1;
...
#line 369
    (&_S5)->material_2 = output_1.material_3;
