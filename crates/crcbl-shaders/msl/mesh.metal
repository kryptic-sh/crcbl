...
#line 2115
    float3 normal_3 = normalize(_S92.world_normal_0);
...
#line 2153
        (&normals_0)->lit_0 = float4(normal_3 * _S93 + _S93, 1.0f);
...
#line 2159
    ...
    float3 to_eye_0 = normalize((&kernelContext_10)->frame_0->camera_position_0.xyz - _S92.world_position_7);



    float3 _S94 = geometric_normal_of_0(_S92.world_position_7, normal_3);

#line 2167
    thread GpuMaterial_natural_0 _S95 = (&kernelContext_10)->materials_0[_S92.material_2];
...
#line 2186
        uv_2 = physical_tile_uv_0(_S92.world_position_7, normal_3, (&_S95)->tile_metres_1);
...
#line 2191
    ...
    float4 albedo_0 = _S92.color_2 * float4((&_S95)->base_color_0)  * (((&kernelContext_10)->base_color_textures_0).sample(((&kernelContext_10)->base_color_sampler_0), ((_S96)).xy, uint(((_S96)).z)));
...
#line 2237
        thread GpuLight_natural_0 _S104 = (&kernelContext_10)->lights_0[(&kernelContext_10)->cluster_lights_0[base_3 + 1U + slot_0]];
...
#line 2278
        float3 specular_0 = ggx_lobe_0(_S97, f0_2, _S109, _S99, max(dot(normal_3, half_vector_0), 0.0f), max(dot(to_eye_0, half_vector_0), 0.0f)) * float3(_S109) ;
...
#line 2293
            float _S110 = sun_visibility_0(_S92.world_position_7, to_light_6, n_dot_l_5, _S94, &kernelContext_10);
...
#line 2309
                    float _S112 = point_visibility_0(&_S104, _S111, _S92.world_position_7, to_light_6, n_dot_l_5, _S94, &kernelContext_10);
...
#line 2315
                    float _S114 = spot_visibility_0(&_S104, _S113, _S92.world_position_7, to_light_6, n_dot_l_5, _S94, &kernelContext_10);
...
#line 2237
    float3 _S116 = specular_compensation_0(f0_2, _S99, roughness_3, &kernelContext_10);

#line 2338
    float3 gloss_2 = gloss_0 * _S116;

#line 2338
    texture2d<float, access::sample> _S117 = (&kernelContext_10)->ambient_occlusion_0;
...
#line 2361
    float occluded_0 = (((&kernelContext_10)->ambient_occlusion_0).read(vec<uint,2>(((_S118)).xy), uint(((_S118)).z)).x);

#line 2374
    float3 _S119 = frame_1->ambient_0.xyz;

#line 2374
    float3 _S120 = probe_irradiance_0(_S92.world_position_7, normal_3, &kernelContext_10);

#line 2394
    float3 lit_1 = diffuse_albedo_0 * ((_S119 + _S120) * float3(occluded_0)  + direct_0) + gloss_2;

#line 2394
    float3 _S121 = emissive_of_0(&_S95);

#line 2430
    float fog_survives_0 = fog_transmittance_0(fog_optical_depth_0((&kernelContext_10)->frame_0->fog_params_0.x, (&kernelContext_10)->frame_0->fog_params_0.y, (&kernelContext_10)->frame_0->camera_position_0.y - (&kernelContext_10)->frame_0->fog_params_0.z, _S92.world_position_7.y - (&kernelContext_10)->frame_0->fog_params_0.z, length((&kernelContext_10)->frame_0->camera_position_0.xyz - _S92.world_position_7)));
    ...
    (&output_0)->lit_0 = float4((lit_1 + _S121) * float3(fog_survives_0)  + (&kernelContext_10)->frame_0->fog_color_0.xyz * float3((1.0f - fog_survives_0)) , albedo_0.w);
...
#line 1075
    GpuInstance_natural_0 device* _S122 = instances_2+visible_instances_2[draw_2->base_0 + instance_id_0];
...
#line 1130
    if(((_S122->flags_0) & 2U) != 0U)
    {

#line 1130
        base_vertex_2 = _S122->base_vertex_0;
...
#line 1132
    matrix<float,int(4),int(4)>  _S123 = matrix<float,int(4),int(4)> (_S122->transform_0.data_0[int(0)][int(0)], _S122->transform_0.data_0[int(1)][int(0)], _S122->transform_0.data_0[int(2)][int(0)], _S122->transform_0.data_0[int(3)][int(0)], _S122->transform_0.data_0[int(0)][int(1)], _S122->transform_0.data_0[int(1)][int(1)], _S122->transform_0.data_0[int(2)][int(1)], _S122->transform_0.data_0[int(3)][int(1)], _S122->transform_0.data_0[int(0)][int(2)], _S122->transform_0.data_0[int(1)][int(2)], _S122->transform_0.data_0[int(2)][int(2)], _S122->transform_0.data_0[int(3)][int(2)], _S122->transform_0.data_0[int(0)][int(3)], _S122->transform_0.data_0[int(1)][int(3)], _S122->transform_0.data_0[int(2)][int(3)], _S122->transform_0.data_0[int(3)][int(3)]);

    float4 world_0 = (((float4((float4(vertex_0.position_0) ).xyz, 1.0f)) * (_S123)));
...
#line 1144
    (&output_1)->world_normal_2 = ((((float4(vertex_0.normal_1) ).xyz) * (normal_basis_0(matrix<float,int(3),int(3)> (_S123[int(0)].xyz, _S123[int(1)].xyz, _S123[int(2)].xyz)))));
...
#line 1151
        _S124 = float4(0.44999998807907104f, 0.44999998807907104f, 0.47999998927116394f, 1.0f);
...
#line 1151
        _S124 = float4(vertex_0.color_0) ;

#line 1151
    }

#line 1150
    (&output_1)->color_4 = _S124;

#line 1157
    (&output_1)->material_4 = _S122->material_0;
    (&output_1)->uv_4 = (float4(vertex_0.uv_0) ).xy;
    VertexOutput_0 _S125 = output_1;

#line 1159
    thread vertexMain_Result_0 _S126;

#line 1159
    (&_S126)->position_3 = _S125.position_4;

#line 1159
    (&_S126)->world_position_8 = _S125.world_position_9;

#line 1159
    (&_S126)->world_normal_1 = _S125.world_normal_2;

#line 1159
    (&_S126)->color_3 = _S125.color_4;

#line 1159
    (&_S126)->material_3 = _S125.material_4;

#line 1159
    (&_S126)->uv_3 = _S125.uv_4;
