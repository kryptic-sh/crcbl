...
#line 926
float sun_visibility_0(float3 world_position_0, float3 to_light_1, float n_dot_l_1, KernelContext_0 thread* kernelContext_2)
{
...
#line 987
    float _S13 = tile_pcf_0(cascade_0, float2(ndc_0.x * 0.5f + 0.5f, 0.5f - ndc_0.y * 0.5f), ndc_0.z, kernelContext_2);
...
#line 1181
float point_visibility_0(const GpuLight_natural_0 thread* light_0, uint base_1, float3 world_position_2, float3 to_light_3, float n_dot_l_3, KernelContext_0 thread* kernelContext_4)
{
...
#line 1189
    float _S21 = punctual_visibility_0(base_1 + point_face_0(from_light_1), world_position_2, to_light_3, n_dot_l_3, 2.0f * max(max(abs(from_light_1.x), abs(from_light_1.y)), abs(from_light_1.z)) / 1024.0f, kernelContext_4);
...
#line 1123
float spot_visibility_0(const GpuLight_natural_0 thread* light_1, uint tile_4, float3 world_position_3, float3 to_light_4, float n_dot_l_4, KernelContext_0 thread* kernelContext_5)
{
...
#line 1137
    float _S23 = punctual_visibility_0(tile_4, world_position_3, to_light_4, n_dot_l_4, 2.0f * (sqrt(saturate(1.0f - cos_outer_1 * cos_outer_1)) / max(cos_outer_1, 0.00009999999747379f)) * max(dot(world_position_3 - (float4(light_1->position_1) ).xyz, normalize(_S22.xyz)), 0.0f) / 1024.0f, kernelContext_5);
...
#line 1384
            to_light_5 = normalize((float4((&_S33)->direction_0) ).xyz);
...
#line 1391
            ...
            float3 to_light_6 = offset_0 / float3(max(distance_1, 9.99999997475242708e-07f)) ;
...
#line 1395
                reach_0 = reach_1 * spot_cone_0(to_light_6, _S37.xyz, _S37.w, (&_S33)->cos_inner_0);
...
#line 1395
            to_light_5 = to_light_6;

#line 1384
        }

#line 1402
        float n_dot_l_5 = dot(normal_1, to_light_5);
        float _S38 = max(n_dot_l_5, 0.0f);

#line 1409
        float3 half_vector_0 = normalize(to_light_5 + to_eye_0);
...
#line 1431
            float _S39 = sun_visibility_0(_S24.world_position_4, to_light_5, n_dot_l_5, &kernelContext_6);
...
#line 1447
                    float _S41 = point_visibility_0(&_S33, _S40, _S24.world_position_4, to_light_5, n_dot_l_5, &kernelContext_6);
...
#line 1453
                    float _S43 = spot_visibility_0(&_S33, _S42, _S24.world_position_4, to_light_5, n_dot_l_5, &kernelContext_6);
