...
//! region this pass filled. Nothing downstream grows a skinning branch — not
//! [`crate::cull`], not [`crate::draw_gen`], not [`crate::shadow`], not the
//! vertex stage. That is why [`SkinnedRegion`] is a range of
